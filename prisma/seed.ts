...
async function main() {
  ...
  const quests = [
    ...
    },
    {
      ...
      description: 'Add your name and profile picture to personalize your Moonshot experience.',
      pointValue: 50,
      type: 'profile',
      category: 'one_time',
      difficulty: 'easy',
    ...
    },
    {
      ...
      description: 'Share your referral link with 3 friends and help grow the Moonshot community.',
      pointValue: 150,
      type: 'social',
      category: 'one_time',
      difficulty: 'medium',
    ...
    },
    {
      ...
      description: 'Browse and engage with 10 different rewards in the storefront.',
      pointValue: 75,
      type: 'social',
      category: 'one_time',
      difficulty: 'easy',
